...
export default function MenuBar({ onMenu, onLogout, active, user }) {
  ...
  return (
    <div className="w-full border-b border-gray-200">
      ...
      <div className="bg-white flex justify-between items-center px-4 md:px-6 py-3 md:py-4">
        <h1 className="text-xl md:text-2xl font-bold text-gray-900">OPTOMETRY</h1>
        <div className="flex items-center gap-2 md:gap-4">
          <div className="text-right text-xs md:text-sm text-gray-700 leading-tight font-medium">
            <div>
          ...
          <div className="w-8 h-8 md:w-9 md:h-9 bg-[#3b6e8f] rounded-full flex items-center justify-center">
            <svg
      ...
      {/* Flat blue menu bar */}
      <div className="bg-[#396b84] flex flex-wrap items-center justify-between px-4 md:px-10 py-2.5 font-serif text-sm text-white gap-2">
            ...
            item.sub ? (
              ...
              >
                <button
                  ...
                  className={`px-3 md:px-4 py-2 rounded-md flex items-center gap-1.5 md:gap-2 font-semibold tracking-wide transition ${
                ...
                {openSubmenuKey === item.key && (
                  <div className={`absolute top-full mt-1 ${
                    item.key === "registers-new" || item.key === "research"
                      ? "right-0 md:right-auto md:left-0"
                      : "left-0"
                  } flex flex-col bg-[#396b84] text-white rounded-md shadow-lg z-50 min-w-[280px]`}>
              ...
              <button
                ...
                className={`px-3 md:px-4 py-2 rounded-md font-semibold tracking-wide transition ${
        ...
        <div className="ml-auto md:ml-0">
          <button
            onClick={onLogout}
            className="bg-white hover:bg-gray-100 px-4 md:px-6 py-2 rounded-md font-semibold text-[#dc2626] transition text-xs md:text-sm"
          >
            Logout
          </button>
        </div>
