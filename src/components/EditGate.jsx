...
export default function EditGate({ user, children }) {
  ...
  async function handleSetPassword() {
    ...
    if (!p1 || !p2) return setError("Enter the password in both fields.");
    ...
    return (
      <div className="max-w-xl mx-auto bg-white border rounded-lg shadow p-5 font-serif">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Create a password to unlock <b>Edit Report</b> for:
          <br />
      ...
      <div className="max-w-xl mx-auto bg-white border rounded-lg shadow p-5 font-serif">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Clear the existing edit password"
          >
